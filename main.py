...
def extract_data_from_gs(filename, service_account_file, scopes):
    ...
    try:
        ...
        # Checks all columns with numbers and converts it to int so filtering operations can be conducted later
...
def chatgpt_query(prompt, header):
    ...
    openai.api_key = 'replace OPENAI KEY HERE'  # Replace OpenAI API key
